...
type Mission = { id: string; title: string; segment: string; objective: string; status: string; progress: number; nextAction: string; stage?: string; evidenceLevel?: string; escalateToHuman?: boolean };
