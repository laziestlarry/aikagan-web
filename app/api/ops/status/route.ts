...
export async function GET(req: NextRequest) {
  ...
  const defaultCheckoutProvider = providers.gumroad ? "gumroad" : providers.shopier ? "shopier" : providers.lemonsqueezy ? "lemonsqueezy" : null;
