...
export const metadata: Metadata = {
  ...
  description:'Join a free network for practical AI business tools. Try useful software, shape what gets built next, and share what helps.',
