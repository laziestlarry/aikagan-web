      ...
      <div className="relative mx-auto grid min-h-[720px] max-w-7xl items-center gap-12 px-6 py-24 lg:grid-cols-[1.08fr_.92fr]">
        <div>
          ...
          <div className="mt-9 flex flex-wrap gap-3">
            <Link href="/intake" className="inline-flex items-center gap-2 rounded-xl bg-amber-300 px-6 py-4 font-black text-black hover:bg-amber-200">Build my recommendation <ArrowRight className="h-4 w-4" /></Link>
