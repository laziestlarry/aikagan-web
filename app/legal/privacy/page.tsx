    ...
    <main className="min-h-screen bg-[#08080a] px-6 py-20 text-white">
      <section className="mx-auto max-w-3xl">
        ...
        <div className="space-y-8 text-neutral-300 leading-relaxed">
          <div><h2 className="text-lg font-semibold text-white mb-3">Who We Are</h2><p>AutonomaX is an AI-powered digital product and implementation business operating at aikagan.com. For privacy inquiries contact: <a href="mailto:kagan@aikagan.com" className="text-amber-300 underline">kagan@aikagan.com</a></p></div>
          ...
          <div><h2 className="text-lg font-semibold text-white mb-3">Data Sharing</h2><p>We do not sell your personal data. Information is shared only as required to operate the service, including:</p><ul className="list-disc list-inside space-y-1 text-neutral-400 mt-2"><li>Gumroad for currently mapped hosted self-serve purchases and its payment, tax and transaction services.</li><li>Hosting, analytics, fulfillment or support providers necessary to operate the requested service.</li><li>Legal authorities when required by applicable law.</li></ul></div>
          ...
          <div><h2 className="text-lg font-semibold text-white mb-3">Your Rights</h2><p>Depending on your location you may have the right to access, correct, object to processing of, or request deletion of personal data we hold about you. Contact <a href="mailto:kagan@aikagan.com" className="text-amber-300 underline">kagan@aikagan.com</a> to exercise applicable rights.</p></div>
          <div><h2 className="text-lg font-semibold text-white mb-3">Contact</h2><p><a href="mailto:kagan@aikagan.com" className="text-amber-300 underline">kagan@aikagan.com</a></p></div>
        </div>
      </section>
    </main>
  );
