...
export const paymentRails: PaymentRail[] = [
  ...
  },
  {
    id: "lemonsqueezy",
    name: "LemonSqueezy",
    description: "Merchant of Record fallback for domains/accounts where approved",
    status: "needs_setup",
    isMoR: true,
    ...
    notes: "aikagan.com was rejected and Lemon depends on Stripe rails that are not viable from Turkey. Keep existing links only as legacy/fallback where they already work.",
  },
  {
    id: "gumroad",
    name: "Gumroad",
    ...
    notes: "Works on current domains. Keep mapped Gumroad permalinks as fallback and marketplace reach.",
  },
  {
    id: "squarespace",
  ...
  },
  {
    ...
    notes: "Keep in use as local-market and fallback checkout; configure PAT or product URLs per slug.",
  },
  {
    id: "binance",
    name: "Binance Pay",
