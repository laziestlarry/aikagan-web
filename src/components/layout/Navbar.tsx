...
export default function Navbar({ locale = 'en' }: { locale?: Locale }) {
  ...
  // /tr is the canonical Turkish surface. Route truth must win even when middleware/header locale is absent.
  const isTurkish = !isAppRoute && (locale === 'tr' || currentPath === '/tr' || currentPath.startsWith('/tr/'));
