...
export const metadata = {
  title: "AIKAGAN Golden Delivery Commander Pack",
  description:
    "Commander-level implementation pack for mapping, operating, and scaling the Golden Delivery revenue system after first proof.",
};
